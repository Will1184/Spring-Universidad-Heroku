...
import org.will1184.springproyectouniversidad.universidadbackend.datos.DatosDummy;
...
class CarreraRepositoryTest {
    ...
    void findCarrerasByNombreContainsIgnoreCase() {
        ...
        //when
        List<Carrera> expected = (List<Carrera>) carreraRepository.findCarreraByNombreContainsIgnoreCase()d("sistemas");
